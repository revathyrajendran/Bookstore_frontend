...
import { adminProfileDetailsUpdateContext } from '../../contextAPI/ContextShare'
            ...
            <div className=" rounded bg-blue-100 p-10 flex justify-center items-center  flex-col md:mt-10 mt-0">
               <input onChange={(e)=>handleUpdateAdminProfilePic(e)} type="file" id='adminpic' className='hidden' />
                   <label htmlFor="adminpic" className='mb-3'>
                        {/*Conditional rendering based on if therfe is an excisting profile pic or if the profile pic is updated .If preview has a value means admin has updated the profiel. If excisiting profile has a value means the profile is not updated.*/}
                    {
